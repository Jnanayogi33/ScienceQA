...
trainRawQA = extractor.extractQA(cache + 'training_set.tsv')[:25]
valRawQA = extractor.extractQA(cache + 'validation_set.tsv', validationSet=True)[:25]
...
import pdb; pdb.set_trace()  # breakpoint e1b8822d //
