...
# Main
start, end = 0, 51
fourthGradeExam = Test(start, end, N=6)
fourthGradeExam.takeTestMindmaps()
numCorrect, numIncorrect = fourthGradeExam.correct, fourthGradeExam.incorrect
answerReport = fourthGradeExam.answerReport
timeReport = fourthGradeExam.timeReport

fourthGradeExam.takeTestW2V()
benchmarkCorrect, benchmarkInorrect = fourthGradeExam.correct, fourthGradeExam.incorrect
benchmarkReport = fourthGradeExam.answerReport

LETTERS = fourthGradeExam.LETTERS
